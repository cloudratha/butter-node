...
var _logout = __webpack_require__(99);
...
var deepEqual = __webpack_require__(158);
...
module.exports.templates = __webpack_require__(166);
...
var _vueRouter = __webpack_require__(188);
...
router.beforeEach(function (to, from, next) {
    if (to.matched.some(function (m) {
        return m.meta.verify;
    }) && !_store2.default.state.auth.active) {
        next({
            name: 'login'
        });
    } else if (to.matched.some(function (m) {
        return m.meta.auth;
    }) && !_store2.default.state.auth.user) {
        next({
            name: 'login'
        });
    } else if (to.matched.some(function (m) {
...
router.afterEach(function () {
    document.body.className = _store2.default.state.route.name;
});
...
_axios2.default.interceptors.response.use(function (response) {
    ...
    if (_store2.default.state.auth.user && error.response.status === 401) {
...
_store2.default.dispatch('authCheck');
...
var ValidationBag = __webpack_require__(67);
var Rule = __webpack_require__(66);
...
var _Master = __webpack_require__(170);

var Master = _interopRequireWildcard(_Master);
...
new _vue2.default(Master).$mount('#app');
...
var _NavHeader = __webpack_require__(178);
...
var _trunc = __webpack_require__(105);
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            currentTime: (0, _trunc2.default)(new Date().getTime() / 1000),
    ...
    computed: {
        remainPoint: function remainPoint() {
            var start = this.activeTime < this.currentTime ? this.currentTime : this.activeTime;
            var total = this.endTime - this.activeTime;
            var active = this.endTime - start;
    ...
    methods: {
        ...
        setup: function setup() {
            ...
            this.$nextTick(function () {
                for (var x = 0; x < this.count; x++) {
                    ...
                    this.order[x].draggable = new _draggabilly2.default(this.$refs.thumb[x], {
        ...
        sliderClick: function sliderClick(e, index) {
            this.active = index;
        },
        ...
        dragMove: function dragMove(e) {
            var x = this.order[this.active].draggable.position.x;
            var newValue = x / this.$refs.slider.getBoundingClientRect().width * 100;
            var converted = this.convertToTimestamp(newValue);
        ...
        convertToTimestamp: function convertToTimestamp(value) {
            var convert = Math.round((this.endTime - this.activeTime) * value / 100 + this.activeTime) - 19;
...
exports.default = {
    mounted: function mounted() {
        (0, _jquery2.default)(this.$refs.slides).fullpage({
            navigation: true,
...
var SimpleVueValidation = __webpack_require__(65);
...
exports.default = {
    ...
    methods: {
        purchase: function purchase() {
            ...
            _axios2.default.post('/api/order', {
                ...
                _this.async = false;
                if (errors.response) {
                    _this.error = 'Your email and password combination does not match.';
                } else {
                    // System error if axios doesnt return a response bag
                    _this.error = 'We are unable to take orders at this time. Please try again later.';
                }
            });
        },
        formatted: function formatted() {
            ...
            try {
                for (var _iterator = (0, _getIterator3.default)(this.order), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
exports.default = {
    ...
    validators: {
        ...
        password_confirm: function password_confirm(value) {
...
exports.default = {
    ...
    methods: {
        ...
        verify: function verify() {
            ...
            _auth2.default.verify({
                verify: this.token()
            });
        },
        validate: function validate() {
            var tokens = this.$refs.token;
...
var success = function success(user) {
    _store2.default.dispatch('login', user);
    _store2.default.dispatch('processEnd');
...
var failed = function failed(response) {
    _store2.default.dispatch('processEnd');
    _store2.default.dispatch('authError', response);
};

exports.default = function (user) {
    _store2.default.dispatch('processStart');
    _vue2.default.$http.post('/api/login', user).then(function (data) {
        success(data);
    }).catch(function (error) {
        failed(error);
    });
...
var failed = function failed(_ref) {
    ...
    _store2.default.dispatch('processEnd');
    _store2.default.dispatch('authError', data);
};

exports.default = function (user) {
    _store2.default.dispatch('processStart');
    _vue2.default.$http.post('/api/register', user).then(function (data) {
        success(data);
...
// When the request succeeds
var success = function success(user) {
    _store2.default.dispatch('verify', user);
    _store2.default.dispatch('processEnd');
    _vue2.default.router.push({
        name: 'order'
    });
...
exports.default = function (user) {
    _store2.default.dispatch('processStart');
    _vue2.default.$http.post('/api/verify', user).then(function (_ref2) {
        var data = _ref2.data;
...
var mutations = {
    AUTH_CHECK: function AUTH_CHECK(state) {
        state.auth = !!localStorage.getItem('token');
        if (state.auth) {
            _vue2.default.$http.defaults.headers.common.Authorization = 'Bearer ' + localStorage.getItem('token');
    ...
    LOGIN: function LOGIN(state, data) {
        ...
        localStorage.setItem('user', (0, _stringify2.default)(data.user));
        _vue2.default.$http.defaults.headers.common.Authorization = 'Bearer ' + data.token;
    },
    VERIFY: function VERIFY(state, _ref) {
        var user = _ref.user;
    ...
    PROCESS_START: function PROCESS_START() {
        state.error = null;
        state.processing = true;
    },
    PROCESS_END: function PROCESS_END() {
        state.processing = false;
    }
};

var actions = {
    authCheck: function authCheck(_ref2) {
    ...
    verify: function verify(_ref5, user) {
        var commit = _ref5.commit;

        commit('VERIFY', user);
    },
    authError: function authError(_ref6, error) {
    ...
    processStart: function processStart(_ref8) {
        var commit = _ref8.commit;

        commit('PROCESS_START');
    },
    processEnd: function processEnd(_ref9) {
...
// module
exports.push([module.i, "\n#register .card {\n  max-width: 600px;\n  margin: 0 auto 2em auto;\n}\n#register .card img {\n    max-width: 8em;\n}\n#register .card form {\n    margin: 2em auto;\n    max-width: 400px;\n}\n#register .card .has-addons {\n    box-shadow: inset 0 1px 2px rgba(10, 10, 10, 0.1);\n}\n#register .card .has-addons span {\n      background-color: white;\n      opacity: 1;\n      padding-right: 0;\n      border: 1px solid white;\n}\n#register .card .has-addons input {\n      border: 1px solid white;\n      box-shadow: none;\n      padding-left: 0;\n}\n", ""]);
...
(function(global, factory) {
    'use strict';
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(63)], __WEBPACK_AMD_DEFINE_RESULT__ = function($) {
...
Component.options.__file = "/Users/garcozen/Documents/repo/butter-node/resources/assets/js/Master.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-11a974d8", Component.options)
  } else {
    hotAPI.reload("data-v-11a974d8", Component.options)
  }
})()}
...
Component.options.__file = "/Users/garcozen/Documents/repo/butter-node/resources/assets/js/components/Slider.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0b6575f8", Component.options)
  } else {
    hotAPI.reload("data-v-0b6575f8", Component.options)
  }
})()}
...
Component.options.__file = "/Users/garcozen/Documents/repo/butter-node/resources/assets/js/views/Account.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-aca5056c", Component.options)
  } else {
    hotAPI.reload("data-v-aca5056c", Component.options)
  }
})()}
...
Component.options.__file = "/Users/garcozen/Documents/repo/butter-node/resources/assets/js/views/Home.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-664e31dc", Component.options)
  } else {
    hotAPI.reload("data-v-664e31dc", Component.options)
  }
})()}
...
Component.options.__file = "/Users/garcozen/Documents/repo/butter-node/resources/assets/js/views/Login.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-27ae3c74", Component.options)
  } else {
    hotAPI.reload("data-v-27ae3c74", Component.options)
  }
})()}
...
Component.options.__file = "/Users/garcozen/Documents/repo/butter-node/resources/assets/js/views/Order.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3b4bff2b", Component.options)
  } else {
    hotAPI.reload("data-v-3b4bff2b", Component.options)
  }
})()}
...
Component.options.__file = "/Users/garcozen/Documents/repo/butter-node/resources/assets/js/views/Register.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-306acd54", Component.options)
  } else {
    hotAPI.reload("data-v-306acd54", Component.options)
  }
})()}
...
Component.options.__file = "/Users/garcozen/Documents/repo/butter-node/resources/assets/js/views/Verify.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-73a87a28", Component.options)
  } else {
    hotAPI.reload("data-v-73a87a28", Component.options)
  }
})()}
...
Component.options.__file = "/Users/garcozen/Documents/repo/butter-node/resources/assets/js/views/partials/NavHeader.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1f41c0f4", Component.options)
  } else {
    hotAPI.reload("data-v-1f41c0f4", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("-")]), _vm._v(" "), _c('span', [_vm._v(_vm._s(this.count))]), _vm._v(" "), _c('span', {
    staticClass: "pointer",
    class: {
      'is-disabled': _vm.max === _vm.count
    },
    on: {
      "click": function($event) {
        $event.preventDefault();
    ...
    ref: "tooltip",
    staticClass: "tooltip"
  }, [_vm._v(_vm._s(_vm.tooltip))]), _vm._v(" "), _c('div', {
    ...
    style: ({
      width: (_vm.remainPoint + 2) + '%',
      left: (_vm.startPoint - 1) + '%'
    })
    ...
    staticClass: "ui-slider-controls"
  }, [_c('span', {
    staticClass: "start"
  }, [_vm._v(_vm._s(_vm.parseTime(_vm.activeTime)))]), _vm._v(" "), _vm._l((46), function(n) {
    return _c('span', [_vm._v("|")])
  }), _vm._v(" "), _c('span', {
    staticClass: "end"
  }, [_vm._v(_vm._s(_vm.parseTime(_vm.endTime)))])], 2)], 2)])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0b6575f8", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-11a974d8", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('nav', {
    staticClass: "nav is-fixed-top is-trans"
  }, [_c('div', {
    staticClass: "container"
  }, [(_vm.$route.name !== 'home') ? _c('div', {
    ...
    attrs: {
      "src": "/images/butter-logo.svg",
      "alt": "Butter Your Bae"
    }
  })])], 1) : _vm._e(), _vm._v(" "), (!_vm.$store.state.auth.user) ? _c('div', {
    staticClass: "nav-right nav-menu is-flex-mobile"
  }, [_c('router-link', {
    ...
    staticClass: "nav-item is-bold"
  }, [_vm._v("Hi, " + _vm._s(_vm.$store.state.auth.user.name))]), _vm._v(" "), _c('li', {
    staticClass: "nav-item"
  }, [_vm._v("|")]), _vm._v(" "), _c('router-link', {
    staticClass: "nav-item is-tab",
    attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-1f41c0f4", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('section', {
    staticClass: "hero is-fullheight is-trans",
    attrs: {
      "id": "login"
    }
  }, [_c('div', {
  ...
  })]), _vm._v(" "), (_vm.$store.state.auth.error) ? _c('p', [_vm._v(_vm._s(_vm.$store.state.auth.error))]) : _vm._e(), _vm._v(" "), _c('button', {
    staticClass: "button is-dark is-medium",
    class: {
      'is-loading': _vm.$store.state.auth.processing
    },
    on: {
      "click": function($event) {
        $event.preventDefault();
  ...
  }, [_vm._v("Login")])])])]), _vm._v("\n            Need an Account? "), _c('router-link', {
    staticClass: "is-link",
    attrs: {
      "to": "/register"
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-27ae3c74", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('section', {
    ...
    attrs: {
      "src": "/images/butter-slice.svg",
      "alt": "Butter Slice"
    }
  }), _vm._v(" "), _c('h1', [_vm._v("Registration")]), _vm._v(" "), _c('form', {
    ref: "register"
  }, [_c('p', {
    staticClass: "control"
  }, [_c('input', {
  ...
  }), _vm._v(" "), (_vm.validation.hasError('name')) ? _c('span', {
    staticClass: "help"
  }, [_vm._v(_vm._s(_vm.validation.firstError('name')))]) : _vm._e()]), _vm._v(" "), _c('p', {
    staticClass: "control"
  }, [_c('input', {
    directives: [{
      name: "model",
  ...
  }), _vm._v(" "), (_vm.validation.hasError('surname')) ? _c('span', {
    staticClass: "help"
  }, [_vm._v(_vm._s(_vm.validation.firstError('surname')))]) : _vm._e()]), _vm._v(" "), _c('p', {
    staticClass: "control"
  }, [_c('input', {
    directives: [{
      name: "model",
  ...
  }), _vm._v(" "), (_vm.validation.hasError('email')) ? _c('span', {
    staticClass: "help"
  }, [_vm._v(_vm._s(_vm.validation.firstError('email')))]) : _vm._e()]), _vm._v(" "), _c('p', [_vm._v("We will need to verify your South African mobile number.")]), _vm._v(" "), _c('div', {
    staticClass: "control"
  }, [_c('p', {
    staticClass: "control has-addons is-expanded"
  }, [_c('span', {
    staticClass: "button is-disabled is-medium"
  }, [_vm._v("+27")]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.mobile),
  ...
  })]), _vm._v(" "), (_vm.validation.hasError('mobile')) ? _c('span', {
    staticClass: "help"
  }, [_vm._v(_vm._s(_vm.validation.firstError('mobile')))]) : _vm._e()]), _vm._v(" "), _c('p', {
    staticClass: "control"
  }, [_c('input', {
    directives: [{
      name: "model",
  ...
  }), _vm._v(" "), (_vm.validation.hasError('password')) ? _c('span', {
    staticClass: "help"
  }, [_vm._v(_vm._s(_vm.validation.firstError('password')))]) : _vm._e()]), _vm._v(" "), _c('p', {
    staticClass: "control"
  }, [_c('input', {
    directives: [{
      name: "model",
    ...
    domProps: {
      "value": _vm._s(_vm.password_confirm)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
  ...
  }), _vm._v(" "), (_vm.validation.hasError('password_confirm')) ? _c('span', {
    staticClass: "help"
  }, [_vm._v(_vm._s(_vm.validation.firstError('password_confirm')))]) : _vm._e()]), _vm._v(" "), (_vm.$store.state.auth.error) ? _c('p', [_vm._v(_vm._s(_vm.$store.state.auth.error))]) : _vm._e(), _vm._v(" "), _c('button', {
    staticClass: "button is-dark is-medium",
    class: {
      'is-loading': _vm.$store.state.auth.processing
    },
  ...
  }, [_vm._v("Register")])])])]), _vm._v("\n            Already Registered? "), _c('router-link', {
    staticClass: "is-link",
    attrs: {
      "to": "/login"
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-306acd54", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('h1', [_vm._v("How many SMS's do you wanna send?")]), _vm._v(" "), _c('slider', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.order),
  ...
  }), _vm._v(" "), _c('small', [_vm._v("Drag the slider markers to set the individual send times")]), _vm._v(" "), _c('h3', [_vm._v("Who do you wanna butter up?"), _c('p'), _vm._v(" "), _c('div', {
    staticClass: "control"
  }, [_c('p', {
    staticClass: "control has-addons is-expanded content has-text-centered"
  }, [_c('span', {
    staticClass: "button is-disabled is-medium"
  }, [_vm._v("+27")]), _vm._v(" "), _c('input', {
    directives: [{
  ...
  })]), _vm._v(" "), (_vm.validation.hasError('receiver')) ? _c('span', {
    staticClass: "help"
  }, [_vm._v(_vm._s(_vm.validation.firstError('receiver')))]) : _vm._e()]), _vm._v(" "), _c('div', {
    staticClass: "purchase content"
  }, [_c('a', {
    staticClass: "button is-medium is-primary",
    class: {
      'is-loading': _vm.async
    },
    on: {
      "click": function($event) {
        $event.preventDefault();
  ...
  }, [_vm._v("Purchase")])]), _vm._v(" "), (_vm.error) ? _c('p', [_vm._v(_vm._s(_vm.error))]) : _vm._e()])], 1)])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3b4bff2b", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "section is-dark"
  }, [_c('div', {
    staticClass: "container has-text-centered content"
  }, [_c('router-link', {
    staticClass: "button is-large is-outlined is-primary",
    attrs: {
      "to": "/order"
    }
  }, [_vm._v("Give me some Butter")])], 1)])])])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "section is-trans"
  }, [_c('div', {
    staticClass: "container has-text-centered content"
  }, [_c('img', {
    staticClass: "hero-logo",
    attrs: {
      "src": "/images/butter-logo-stacked.svg",
      "alt": "Butter Your Bae"
    }
  }), _vm._v(" "), _c('h1', [_vm._v("Time to spread that love")])])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "section is-dark"
  }, [_c('div', {
    staticClass: "container has-text-centered content"
  }, [_c('h1', [_vm._v("\n                    Messed up last year for Valentines?"), _c('br'), _vm._v("\n                    Don't worry we've got your bae covered\n                ")]), _vm._v(" "), _c('h1', [_vm._v("Send some sausy messages.")])])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "section is-trans"
  }, [_c('div', {
    staticClass: "container has-text-centered content"
  }, [_c('h1', [_vm._v("\"Here is an example SMS.\"")])])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-664e31dc", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('section', {
    ...
    staticClass: "card-content"
  }, [_c('h1', [_vm._v("Verify your Mobile Number")]), _vm._v(" "), _c('form', {
    ref: "verify"
  }, [_c('div', {
  ...
  })), _vm._v(" "), (_vm.errors) ? _c('p', [_vm._v(_vm._s(_vm.errors))]) : _vm._e(), _vm._v(" "), _c('button', {
    staticClass: "button is-dark is-medium",
    class: {
      'is-loading': _vm.$store.state.auth.processing
    },
  ...
  }, [_vm._v("Verify")])])])]), _vm._v("\n            We need to make sure you're not a robot, or a spammer :)\n        ")])])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-73a87a28", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  })]), _vm._v(" "), (_vm.error) ? _c('p', [_vm._v(_vm._s(_vm.error))]) : _vm._e(), _vm._v(" "), _c('button', {
    staticClass: "button is-dark is-medium",
    class: {
      'is-loading': _vm.async
    },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-aca5056c", module.exports)
  }
}
...
var update = __webpack_require__(6)("6aa14166", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-0b6575f8!./../../../../node_modules/sass-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Slider.vue", function() {
     var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-0b6575f8!./../../../../node_modules/sass-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Slider.vue");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("02912108", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-11a974d8!./../../../node_modules/sass-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Master.vue", function() {
     var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-11a974d8!./../../../node_modules/sass-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Master.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("0bd73354", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!./../../../../../node_modules/css-loader/index.js!./../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-1f41c0f4!./../../../../../node_modules/sass-loader/index.js!./../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./NavHeader.vue", function() {
     var newContent = require("!!./../../../../../node_modules/css-loader/index.js!./../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-1f41c0f4!./../../../../../node_modules/sass-loader/index.js!./../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./NavHeader.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("600c7b68", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-27ae3c74!./../../../../node_modules/sass-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Login.vue", function() {
     var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-27ae3c74!./../../../../node_modules/sass-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Login.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("c2e2741c", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-306acd54!./../../../../node_modules/sass-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Register.vue", function() {
     var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-306acd54!./../../../../node_modules/sass-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Register.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("5fe2faa8", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3b4bff2b!./../../../../node_modules/sass-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Order.vue", function() {
     var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3b4bff2b!./../../../../node_modules/sass-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Order.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("436c7c88", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-664e31dc!./../../../../node_modules/sass-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Home.vue", function() {
     var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-664e31dc!./../../../../node_modules/sass-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Home.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("4e2d6df7", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-73a87a28!./../../../../node_modules/sass-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Verify.vue", function() {
     var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-73a87a28!./../../../../node_modules/sass-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Verify.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("187a291c", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-aca5056c!./../../../../node_modules/sass-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Account.vue", function() {
     var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-aca5056c!./../../../../node_modules/sass-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Account.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
